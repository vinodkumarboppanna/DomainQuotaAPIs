...
class RequestContext(object):
    ...
    def __init__(self, user_id, project_id, is_admin=None, read_deleted="no",
                 ...
                 service_catalog=None, instance_lock_checked=False, domain_id=None, project_domain_id=None,
                 user_domain_id=None, **kwargs):
        """
...
def authorize_domain_project_context(context, domain_id, project_id):
    ...
    if is_user_context(context):
        if not context.domain_id:
            ...
            if (context.domain_id != domain_id) or (context.project_id != project_id):
                raise exception.NotAuthorized()
...
def authorize_project_user_context(context, project_id, user_id):
    ...
    if is_user_context(context):
        if not context.user_id:
            ...
            if (context.user_id != user_id) or (context.project_id != project_id):
                raise exception.NotAuthorized()
