...
def domain_quota_update(context, domain_id, resource, limit):
    """Create a quota for the given domain and resource."""
    return IMPL.domain_quota_update(context, domain_id, resource,
                                     limit)
...
def quota_get_all_by_domain(context, domain_id):
    """Retrieve all quotas associated with a given domain."""
    return IMPL.quota_get_all_by_domain(context, domain_id)
...
def quota_get_all_for_domain(context, domain_id, project_id):
    """Retrieve all project quotas associated with a given domain."""
    return IMPL.quota_get_all_for_domain(context, domain_id, project_id)
...
def quota_destroy_all_by_domain(context, domain_id):
    """Destroy all quotas associated with a given domain."""
    return IMPL.quota_destroy_all_by_domain(context, domain_id)
