...
from nova.api.openstack.compute.contrib import domain_quotas
...
class DomainQuotaSetsTest(test.TestCase):

    def setUp(self):
        super(DomainQuotaSetsTest, self).setUp()
        self.ext_mgr = self.mox.CreateMock(extensions.ExtensionManager)
        self.controller = domain_quotas.DomainQuotaSetsController(self.ext_mgr)
    ...
    def test_quotas_defaults(self):
        uri = '/v2/fake_tenant/domain-quota-sets/fake_domain/defaults'

        req = fakes.HTTPRequest.blank(uri)
        res_dict = self.controller.defaults(req, 'fake_domain')
    ...
    def test_quotas_show_as_admin(self):
        ...
        self.mox.ReplayAll()
        req = fakes.HTTPRequest.blank('/v2/fake4/domain-quota-sets/1234',
    ...
    def test_quotas_update_as_admin(self):
        ...
        req = fakes.HTTPRequest.blank('/v2/fake4/domain-quota-sets/update_me',
                                      use_admin_context=True)
    ...
    def test_quotas_delete_as_admin(self):
        ...
        self.req = fakes.HTTPRequest.blank('/v2/fake4/domain-quota-sets/1234')
        self.req.environ['nova.context'] = context
        #self.ext_mgr.is_loaded('os-extended-quotas').AndReturn(True)
        self.mox.StubOutWithMock(quota.QUOTAS,
                                 "destroy_all_by_domaind")
        quota.QUOTAS.destroy_all_by_domain(context, 1234)
        self.mox.ReplayAll()
        res = self.controller.delete(self.req, 1234)
        self.mox.VerifyAll()
        self.assertEqual(res.status_int, 202)

    def test_project_quotas_show_as_admin(self):
        #self.ext_mgr.is_loaded('os-user-quotas').AndReturn(True)
        self.mox.ReplayAll()
        req = fakes.HTTPRequest.blank('/v2/fake4/domain-quota-sets/1234?project_id=1',
                                      use_admin_context=True)
        res_dict = self.controller.show(req, 1234)

        self.assertEqual(res_dict, quota_set('1'))

    def test_project_quotas_show_as_unauthorized_user(self):
        #self.ext_mgr.is_loaded('os-user-quotas').AndReturn(True)
        #self.mox.ReplayAll()
        req = fakes.HTTPRequest.blank('/v2/fake4/domain-quota-sets/1234?project_id=1')
        self.assertRaises(webob.exc.HTTPForbidden, self.controller.show,
    ...
    def test_project_quotas_update_as_admin(self):
        #self.ext_mgr.is_loaded('os-extended-quotas').AndReturn(True)
        #self.ext_mgr.is_loaded('os-user-quotas').AndReturn(True)
        self.mox.ReplayAll()
        ...
        url = '/v2/fake4/domain-quota-sets/update_me?project_id=1'
        req = fakes.HTTPRequest.blank(url, use_admin_context=True)
        res_dict = self.controller.update(req, 'update_me', body)

        self.assertEqual(res_dict, body)

    def test_project_quotas_update_as_user(self):
        #self.ext_mgr.is_loaded('os-extended-quotas').AndReturn(True)
        #self.ext_mgr.is_loaded('os-user-quotas').AndReturn(True)
        self.mox.ReplayAll()
        body = {"quota_set": {"instances": 10, "cores": 20,
    ...
    def test_project_quotas_update_exceed_domain(self):
        #self.ext_mgr.is_loaded('os-extended-quotas').AndReturn(True)
        #self.ext_mgr.is_loaded('os-user-quotas').AndReturn(True)
        self.mox.ReplayAll()
    ...
    def test_project_quotas_delete_as_unauthorized_user(self):
        #self.ext_mgr.is_loaded('os-extended-quotas').AndReturn(True)
        #self.ext_mgr.is_loaded('os-user-quotas').AndReturn(True)
        self.mox.ReplayAll()
        req = fakes.HTTPRequest.blank('/v2/fake4/domain-quota-sets/1234?project_id=1')
    ...
    def test_project_quotas_delete_as_admin(self):
        context = context_maker.get_admin_context()
        url = '/v2/fake4/domain-quota-sets/1234?project_id=1'
        self.req = fakes.HTTPRequest.blank(url)
        self.req.environ['nova.context'] = context
        #self.ext_mgr.is_loaded('os-extended-quotas').AndReturn(True)
        #self.ext_mgr.is_loaded('os-user-quotas').AndReturn(True)
        self.mox.StubOutWithMock(quota.QUOTAS,
                                 "destroy_all_by_project_in_domain")
        quota.QUOTAS.destroy_all_by_project_in_domain(context, '1')
        self.mox.ReplayAll()
        res = self.controller.delete(self.req, '1234')
        self.mox.VerifyAll()
        self.assertEqual(res.status_int, 202)
    ...
    def test_user_quotas_show_as_admin(self):
        #self.ext_mgr.is_loaded('os-user-quotas').AndReturn(True)
        self.mox.ReplayAll()
        req = fakes.HTTPRequest.blank('/v2/fake4/domain-quota-sets/1234?project_id=1&user_id=2',
                                      use_admin_context=True)
        res_dict = self.controller.show(req, 1234)

        self.assertEqual(res_dict, quota_set('2'))
    ...
    def test_user_quotas_update_as_admin(self):
        ...
        url = '/v2/fake4/domain-quota-sets/update_me?project_id=1&user_id=2'
        req = fakes.HTTPRequest.blank(url, use_admin_context=True)
        res_dict = self.controller.update(req, 'update_me', body)
    ...
    def test_user_quotas_delete_as_admin(self):
        context = context_maker.get_admin_context()
        url = '/v2/fake4/domain-quota-sets/1234?project_id=1&user_id=2'
        self.req = fakes.HTTPRequest.blank(url)
        self.req.environ['nova.context'] = context
        #self.ext_mgr.is_loaded('os-extended-quotas').AndReturn(True)
        #self.ext_mgr.is_loaded('os-user-quotas').AndReturn(True)
        self.mox.StubOutWithMock(quota.QUOTAS,
                                 "destroy_all_by_project_and_user_in_domain")
        quota.QUOTAS.destroy_all_by_project_and_user_in_domain(context, '1', '2')
        self.mox.ReplayAll()
        res = self.controller.delete(self.req, '1234')
        self.mox.VerifyAll()
        self.assertEqual(res.status_int, 202)
    ...
    def test_quotas_update_exceed_in_used(self):
        ...
        self.stubs.Set(domain_quotas.DomainQuotaSetsController, '_get_quotas',
                       fake_get_quotas)
        req = fakes.HTTPRequest.blank('/v2/fake4/domain-quota-sets/update_me',
                                      use_admin_context=True)
        #self.ext_mgr.is_loaded('os-extended-quotas').AndReturn(True)
...
class QuotaXMLSerializerTest(test.TestCase):
    def setUp(self):
        ...
        self.serializer = domain_quotas.QuotaTemplate()
    ...
    def test_serializer(self):
        ...
        self.assertEqual('domain_id', tree.get('id'))
...
def fake_get_quotas(self, context, id, project_id=None, user_id=None, usages=False):
    if usages:
        return fake_quotas
    else:
